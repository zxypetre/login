...
def login():
    ...
    if T==None:
        #code=400
        return jsonify({"errcode":1,"msg":"用户名错误","code":400})
        #return '用户名错误',code
    elif T['password']==None or T['password']!=password:
        #code=410
        #return '密码错误',code
        return jsonify({"errcode":1,"msg":"密码错误","code":410})
...
def registered():
    ...
    if U!=None:
        ...
        print(1)
        #return '用户名已存在',code
        return jsonify({"errcode":1,"msg":"用户名已存在","code":400})
    elif E!=None: 
        code=410
        print(2)
        #return 'Email已注册',code
        return jsonify({"errcode":1,"msg":"Email已注册","code":410})
    elif username=='':
        code=420
        print(3)
        #return '用户名不能为空',code
        return jsonify({"errcode":1,"msg":"用户名不能为空","code":420})
    elif password=='':
        code=430
        print(4)
        #return '密码不能为空',code
        return jsonify({"errcode":1,"msg":"密码不能为空","code":430})
    elif password != confirm:
        code = 440
        print(5)
        #return '两次密码不相同',code
        return jsonify({"errcode":1,"msg":"两次密码不相同","code":440})
    else:
...
def email_change_password():
    ...
    if password == confirm_password:
        return jsonify({"errcode":0})
    return jsonify({"errcode":1,"msg":"两次密码不相同"})
...
def change_password():
    ...
    return jsonify({"errcode":1,"msg":"密码不相同","code":400})    
